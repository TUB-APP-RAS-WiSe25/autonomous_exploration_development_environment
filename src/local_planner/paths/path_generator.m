...
wheelbase = 0.3;             % [m] Distance between front and rear axles (measured: 0.3 m)
deltaMax = 30 * pi/180;      % [rad] maximum steering angle (30 degrees, see twist_to_ackermann.cpp)
